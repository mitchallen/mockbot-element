module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-mockbot-element'
                        // standalone: 'mitchallen.-mockbot-element'
                    },
                ...
                files: {
                   ...
                   "./dist/mockbot-element.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/mockbot-element.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/mockbot-element.min.js': ['./dist/mockbot-element.js']
                }
            }
        },
